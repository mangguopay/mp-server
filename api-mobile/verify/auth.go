...
func MobileLoginReqVerify(req *go_micro_srv_auth.MobileLoginRequest) string {
	...
	fildChk = ss_chk.DoFieldChk(fildChk, req.AccountType, "!=", "", ss_err.ERR_PARAM, "account_type")
	...
	//	ss_log.Error("err=[MobileLogin 接口------> %s 为空]", "AccountType")
	//}
	return ""
}
...
func AddAuthMaterialInfoVerify(req *go_micro_srv_cust.AddAuthMaterialInfoRequest) string {
	fildChk := ss_chk.DoFieldChk(nil, req.AccountUid, "!=", "", ss_err.ERR_PARAM, "AccountUid")
	fildChk = ss_chk.DoFieldChk(fildChk, req.FrontImgNo, "!=", "", ss_err.ERR_PARAM, "FrontImgNo")
	fildChk = ss_chk.DoFieldChk(fildChk, req.BackImgNo, "!=", "", ss_err.ERR_PARAM, "BackImgNo")
	...
	if !fildChk.IsOk {
		ss_log.Error("err=[AddAuthMaterialInfo 接口------> %s 为空]", fildChk.ErrReason)
		return fildChk.ErrCode
	}
	return ""
}
func AddAppFingerprintVerify(req *go_micro_srv_auth.AddAppFingerprintRequest) string {
	fildChk := ss_chk.DoFieldChk(nil, req.AccountNo, "!=", "", ss_err.ERR_PARAM, "AccountNo")
	fildChk = ss_chk.DoFieldChk(fildChk, req.DeviceUuid, "!=", "", ss_err.ERR_PARAM, "DeviceUuid")
	if !fildChk.IsOk {
		ss_log.Error("err=[AddAppFingerprint 接口------> %s 为空]", fildChk.ErrReason)
		return fildChk.ErrCode
	}
	return ""
}
func CloseAppFingerprintVerify(req *go_micro_srv_auth.CloseAppFingerprintRequest) string {
	fildChk := ss_chk.DoFieldChk(nil, req.AccountNo, "!=", "", ss_err.ERR_PARAM, "AccountNo")
	fildChk = ss_chk.DoFieldChk(fildChk, req.DeviceUuid, "!=", "", ss_err.ERR_PARAM, "DeviceUuid")
	if !fildChk.IsOk {
		ss_log.Error("err=[CloseAppFingerprint 接口------> %s 为空]", fildChk.ErrReason)
		return fildChk.ErrCode
	}
	return ""
}
