...
// 获取账户列表
func (a *AdminAuth) GetRoleUrlList(ctx context.Context, req *adminAuthProto.GetRoleUrlListRequest, reply *adminAuthProto.GetRoleUrlListReply) error {
	...
	datas := []*adminAuthProto.RoleUrlListData{}
...
func (a *AdminAuth) GetRoleList(ctx context.Context, req *adminAuthProto.GetRoleListRequest, reply *adminAuthProto.GetRoleListReply) error {
...
func getRoleUrlData(urlUid, roleNo string) []*adminAuthProto.RoleUrlListData {
	dbHandler := db.GetDB(constants.DB_CRM)
	defer db.PutDB(constants.DB_CRM, dbHandler)
	...
	if err == nil {
		for rows.Next() {
			data := adminAuthProto.RoleUrlListData{}
...
func getRoleUrlData2(urlUid, roleNo, masterAccs string) []*adminAuthProto.RoleUrlListData {
	dbHandler := db.GetDB(constants.DB_CRM)
	defer db.PutDB(constants.DB_CRM, dbHandler)
...
// 获取账户列表
func (a *AdminAuth) GetRoleInfo(ctx context.Context, req *adminAuthProto.GetRoleInfoRequest, reply *adminAuthProto.GetRoleInfoReply) error {
	dbHandler := db.GetDB(constants.DB_CRM)
	defer db.PutDB(constants.DB_CRM, dbHandler)
...
// 获取账户
func (a *AdminAuth) GetRole(ctx context.Context, req *adminAuthProto.GetRoleRequest, reply *adminAuthProto.GetRoleReply) error {
	dbHandler := db.GetDB(constants.DB_CRM)
	defer db.PutDB(constants.DB_CRM, dbHandler)
...
// 删除账户
func (a *AdminAuth) DeleteRole(ctx context.Context, req *adminAuthProto.DeleteRoleRequest, reply *adminAuthProto.DeleteRoleReply) error {
...
// 更新或者插入授权信息
func (a *AdminAuth) UpdateOrInsertRoleAuth(ctx context.Context, req *adminAuthProto.UpdateOrInsertRoleAuthRequest, reply *adminAuthProto.UpdateOrInsertRoleAuthReply) error {
	dbHandler := db.GetDB(constants.DB_CRM)
	defer db.PutDB(constants.DB_CRM, dbHandler)
...
// 更新或者插入新主商户
func (a *AdminAuth) UpdateOrInsertRole(ctx context.Context, req *adminAuthProto.UpdateOrInsertRoleRequest, reply *adminAuthProto.UpdateOrInsertRoleReply) error {
	dbHandler := db.GetDB(constants.DB_CRM)
	defer db.PutDB(constants.DB_CRM, dbHandler)
	tx, err := dbHandler.Begin()
...
func (a *AdminAuth) AuthRole(ctx context.Context, req *adminAuthProto.AuthRoleRequest, reply *adminAuthProto.AuthRoleReply) error {
	dbHandler := db.GetDB(constants.DB_CRM)
	defer db.PutDB(constants.DB_CRM, dbHandler)
	tx, err := dbHandler.Begin()
	if nil != err {
