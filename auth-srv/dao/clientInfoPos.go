...
// 插入一条记录
func (c *ClientInfoPosDao) Insert() error {
	dbHandler := db.GetDB(constants.DB_CRM)
	defer db.PutDB(constants.DB_CRM, dbHandler)

	sqlStr := "INSERT INTO client_info_pos (id, device_brand, device_model, resolution, screen_size, "
